...
#define AppName "Bazar y Papelería"
#define AppVersion "2.0.0"
#define AppPublisher "Bazar y Papelería"
#define AppExeName "bazarnicole.exe"
...
AppPublisherURL=https://bazarnicole.com
AppSupportURL=https://bazarnicole.com/soporte
AppUpdatesURL=https://bazarnicole.com/actualizaciones
DefaultDirName={autopf}\BazarPapeleria
...
OutputBaseFilename=bazarnicole_Setup_v{#AppVersion}
...
[CustomMessages]
spanish.WelcomeLabel1=Bazar y Papelería
...
spanish.FinishedLabelNoIcons=Bazar y Papelería está listo para usar.
spanish.FinishedLabel=Bazar y Papelería está listo para usar.%n%nPuedes iniciarlo desde el menú de inicio o el escritorio.
...
spanish.PreparingDesc=Preparando la instalación de Bazar y Papelería...
...
begin
  case CurStep of
    ssInstall:
      WizardForm.StatusLabel.Caption := 'Instalando Bazar y Papelería...';
    ssPostInstall:
