...
def create_premium_sidebar():
    ...
    # ========== LOGO REAL DE  Papeleria ==========
    center_x = width // 2
    center_y = height // 2 - 20

    # Cargar logo original
    logo_path = "assets/image/logobazasr.png"
...
def create_app_icon():
    """Crea el icono principal de la aplicación usando el logo de  Papeleria"""
    ...
    try:
        ...
        print(f"✓ Icono PNG creado: {output_png} (usando logobazasr.png)")
...
if __name__ == "__main__":
    print("=" * 70)
    print("  GENERADOR DE ASSETS PREMIUM - INSTALADOR Bazar Papeleria")
