...
%INNO_SETUP% "bazarnicole_Premium_Setup.iss"
...
if %ERRORLEVEL% EQU 0 (
    ...
    echo.
    echo 📊 Información:
    if exist "installer_output\bazarnicole_Setup_v2.0.0.exe" (
        for %%I in ("installer_output\bazarnicole_Setup_v2.0.0.exe") do (
    ...
    start "" "installer_output\bazarnicole_Setup_v2.0.0.exe"
) else (
    echo.
    echo ╔════════════════════════════════════════════════════════════════╗
